...
double GH1::FitEvalShift(double *dim,double *par) {
...
TF1  *GH1::ConstructTF1Shift() const {
  if(GetDimension()!=1)
    return 0;

  ROOT::Math::ParamFunctor *f = new  ROOT::Math::ParamFunctor((GH1*)this,&GH1::FitEvalShift);
  double low  = GetXaxis()->GetBinLowEdge(1);
  double high = GetXaxis()->GetBinUpEdge(GetXaxis()->GetNbins());
