...
void HandleGretSim(TRuntimeObjects &obj){
  ...
  for(unsigned int x = 0; x < gretina->Size(); x++){
    ...
    //double EfficiencyCorrection = (1+TMath::TanH((gretina->GetGretinaHit(x).GetCoreEnergy())/1))/2;
    ...
    obj.FillHistogram(dirname,"gretina_summary_B&T",44,1,44,number,8000,0,4000,energy_track);
