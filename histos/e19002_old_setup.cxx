...
//  InitMap();
  ...
  double tof_obje1 = s800->GetMTof().GetCorrelatedObjE1Chn15(); 
  double tof_xfpe1 = s800->GetMTof().GetCorrelatedXfpE1Chn15();
  obj.FillHistogram("ungated", "incoming_pid", 1000, -4000, 0, tof_obje1,
                                               1000, 0, 4000, tof_xfpe1);

  double ic_ave = s800->GetIonChamber().GetAve();; //what is get ave again?
  double tof_obje1_corr = s800->GetMTofObjE1Chn15(); 
