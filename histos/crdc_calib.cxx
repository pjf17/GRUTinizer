...
void MakeHistograms(TRuntimeObjects& obj) {
  ...
  if (s800){
    ...
    obj.FillHistogram("ungated", "crdc1 X_Y", 250, -100, 400, crdc_1_x, 300, ylow, yhigh, crdc_1_y);  
    obj.FillHistogram("ungated", "crdc2 X_Y", 250, -100, 400, crdc_2_x, 300, ylow, yhigh, crdc_2_y);
